...
export PS3=$'\e[01;35m(*)\e[01;32m Elige opcion:\e[01;33m '

#opciones menu

A="Perzonalizar Termux"

B="Restablecer por defecto"
...
case $menu in
$a)
echo -e "$purple(*)$blue Eliga el estilo de inicio de Termux"
sleep 2
style_banner
...
$b)
echo -e "$purple(*)$blue Programa creado por$Termux-Byte"
sleep 2
